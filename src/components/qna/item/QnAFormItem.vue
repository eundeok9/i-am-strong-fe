...
<template>
  <form @submit.prevent="onSubmit">
    ...
    <div class="row">
      <div class="col-12">
        <textarea class="form-control" rows="20" cols="10" v-model="questions.question" style="resize: none; border: 1px solid black"></textarea>
      </div>
    </div>
    <!-- 글 내용 End -->
    <br />
    <div class="row justify-content-center">
      <div class="col-auto">
        <button type="submit" class="btn btn-outline-success mb-3">질문 등록</button>
      </div>
      <!-- View List Button Start -->
      <div class="col-auto">
        <button class="btn btn-outline-dark mb-3" @click="moveList">목록보기</button>
      </div>
